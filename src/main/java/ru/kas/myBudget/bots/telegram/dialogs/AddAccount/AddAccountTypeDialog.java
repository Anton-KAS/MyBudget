...
public class AddAccountTypeDialog implements Dialog, Callback {
    ...
    public AddAccountTypeDialog(BotMessageService botMessageService, TelegramUserService telegramUserService,
